...
public class Stepdefs {
    ...
    private void registerWith(String username, String password, String passwordConfirmation) {
        ...
        WebElement registration = driver.findElement(By.name("username"));
        registration.sendKeys(username);

        registration = driver.findElement(By.name("password"));
        registration.sendKeys(password);

        registration = driver.findElement(By.name("passwordConfirmation"));
        registration.sendKeys(passwordConfirmation);
